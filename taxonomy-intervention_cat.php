...
<div class="container">
  ...
  <div class="category_wrapper">
    ...
    <ul class="category_list">
      ...
      <li class="category_list_item">
        <a href="/intervention_cat/intervention/<?php echo $term->slug; ?>" target="_blank">
          <?php echo $term->description; ?>
          <p class="category_list_item_label category_list_item_label_intervention<?php echo $term_number; ?>">
            <?php echo $term->name; ?>
          </p>
        </a>
        </li>
  ...
  <?php
  $term_class_map01 = [
    'vem'       => 'category_bg_css_intervention1',
    'rpfaat'    => 'category_bg_css_intervention1',
    'hms'       => 'category_bg_css_intervention1',
    'stbn'      => 'category_bg_css_intervention2',
    'nvtrp'     => 'category_bg_css_intervention2',
    'drp'       => 'category_bg_css_intervention2',
    'idpm'      => 'category_bg_css_intervention3',
    'others'    => 'category_bg_css_intervention4',
    'ri'        => 'category_bg_css_intervention5',
  ];

  $term_class_map02 = [
    'vem'       => 'category_border_css_intervention1',
    'rpfaat'    => 'category_border_css_intervention1',
    'hms'       => 'category_border_css_intervention1',
    'stbn'      => 'category_border_css_intervention2',
    'nvtrp'     => 'category_border_css_intervention2',
    'drp'       => 'category_border_css_intervention2',
    'idpm'      => 'category_border_css_intervention3',
    'others'    => 'category_border_css_intervention4',
    'ri'        => 'category_border_css_intervention5',
  ];

  $current_term = get_queried_object();
  if (!is_tax('intervention_cat') || ($current_term && $current_term->parent != 0)):
    ...
    $term_bgcolor = isset($term_class_map01[$slug]) ? $term_class_map01[$slug] : 'category_bg_css_intervention_default';
    $term_bordercolor = isset($term_class_map02[$slug]) ? $term_class_map02[$slug] : 'category_border_css_intervention_default';
  ?>
  <div>
