...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    wp_redirect(site_url('/dealer/members/form/')); // Redirect if accessed without POST
    exit;
}
?>
    ...
    <div class="container">
        ...
        <div class="category_wrapper">
            ...
            <div class="registerForm">
                <form name="form" method="post" action="<?php echo esc_url(home_url('/dealer/form/complete/')); ?>" id="wpmem_register_form" class="form">
                    <div class="registerForm__content">
                        ...
                        <div class="registerForm__contentFlex">
                            ...
                            <div class="registerForm__contentInput">
                                <div class="registerForm__contentInputFlex">
                                    <span class="registerForm__contentInputItemData"><?php echo esc_html($formData['username']); ?></span>
                                    <input type="hidden" name="username" value="<?php echo esc_attr($formData['username']); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="registerForm__contentFlex">
